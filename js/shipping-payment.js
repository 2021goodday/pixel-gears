document.addEventListener("DOMContentLoaded", function() {
    $('.btn').on('click', function() {
      ...
      $('#payment-cc, #payment-paypal, #payment-cod').on('change', function () {
        if ($(this)[0].id === 'payment-cc') {
          ...
          $('.message').eq(2).addClass('is-hidden').removeClass('is-visible');
      } else if ($(this)[0].id === 'payment-paypal'){
          $('.message').eq(1).addClass('is-visible').removeClass('is-hidden');
          $('.message').eq(0).addClass('is-hidden').removeClass('is-visible');
          $('.message').eq(2).addClass('is-hidden').removeClass('is-visible');
      } else {
          $('.message').eq(2).addClass('is-visible').removeClass('is-hidden');
          $('.message').eq(0).addClass('is-hidden').removeClass('is-visible');
          $('.message').eq(1).addClass('is-hidden').removeClass('is-visible');
      }
    });
    console.log("JavaScript file is loaded after DOM is ready");
});
